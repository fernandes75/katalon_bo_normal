...
//Digiação do Cabeçalho do Documento
selenium.type("name=arRolHod1[]", "001")
selenium.typeKeys("name=arRolHod1[]", Keys.chord(Keys.ENTER))
selenium.type("name=arRolHod2[]", "11/06/2021")
selenium.typeKeys("name=arRolHod2[]", Keys.chord(Keys.ENTER))
...
for (int second = 0;; second++) {
	if (second >= 60) fail("timeout");
	try { if (selenium.isEditable("name=arRolHod6[]")) break; } catch (Exception e) {}
	Thread.sleep(1000);
}

selenium.type("name=arRolHod6[]", "04045")
...
selenium.type("xpath=(//input[@name='arQtdCategoria[]'])[5]", "2")
...
selenium.type("xpath=(//input[@name='arQtdCategoria[]'])[11]", "27")
...
selenium.type("xpath=(//input[@name='arQtdCategoria[]'])[13]", "95")
